...
/** v2 appends a {@link SIGNATURE_BYTES}-byte recoverable ECDSA signature; v1 stays unsigned. */
...
/** A recoverable ECDSA signature: 64 bytes (r, s) plus a 1-byte recovery id. */
...
const KIND_TO_CODE: Record<MemoKind, number> = { memory: 0x01, pin: 0x02, consensus: 0x03 };
...
/** The unsigned payload budget minus the bytes the signature push adds. */
